...
; (function () {
  ...
  var cssText = [
    ...
    '.yass-content { height: 100%; width: 100%; padding: 0 40px 0 0; position: relative; overflow-x: hidden; overflow-y: scroll; -moz-box-sizing: content-box; box-sizing: content-box; }',
